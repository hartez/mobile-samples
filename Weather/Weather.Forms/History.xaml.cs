...
namespace Weather.Forms
{
	...
	public class HistoryRecorder
	{
		...
		{
			new HistoryItem(DateTime.Now.AddHours(-4), "46901", "Howard County", "day200"),
			new HistoryItem(DateTime.Now.AddHours(-3), "47803", "Terre Haute", "day202"),
			new HistoryItem(DateTime.Now.AddHours(-2), "90210", "Beverly Hills", "night300"),
			new HistoryItem(DateTime.Now.AddHours(-1), "80021", "Broomfield", "701"),
